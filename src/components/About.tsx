      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            A Just Tech é uma agência focada em melhoria operacional através da tecnologia. Nosso objetivo é identificar gargalos dentro das empresas e implementar soluções tecnológicas simples que aumentem produtividade, organização e eficiência no dia a dia do negócio.
          </p>
        </div>
